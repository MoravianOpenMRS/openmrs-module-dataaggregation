...
public class CSVFormatter {
	...
	public static String testQueryFormatter(List<Object> results){
	...
	public static String diseaseQueryFormatter(List<Object> results){
	...
	public static String weightQueryFormatter(List<Object> results){
