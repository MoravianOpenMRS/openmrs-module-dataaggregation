...
public class TestsOrderedQuery extends DataAggregationQuery {
	 ...
	 *            "desiredTest0:desiredTest1:...:desiredTestN" This method will
	 *            only list the results of the test specified in this string. If
	 *            this parameter is null, then all tests will be included in the
	 *            result.
	 * @param startDate
	 ...
	 *         there are no results the string will be empty
	 */
	public List<Object> getQueryInfo(String testList, String cityList, String 
		...
		if (testList == null) {
			...
			tests = Arrays.asList(testList.split(":")); // make the long string into a list
		}
	...
	private List<Object> getTestsOrdered(List<String> testsOrderedList, List<String> cities, String startDate, String endDate, Integer minNumber, Integer maxNumber) {
			...
			int num_coded = getConceptIdOfKeyWord("TESTS ORDERED"); // call the function that gets the concept_id # of "TESTS ORDERED"
